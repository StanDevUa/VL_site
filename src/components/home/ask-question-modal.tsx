...
function AskForm() {
  ...
  return (
    <>
      <div className="mb-2 pr-11 font-heading text-2xl leading-[1.2] font-extrabold text-navy">
        {t("modalTitle")}
      </div>
      <p className="mb-6 text-[15.5px] leading-[1.65] text-navy-soft">{t("modalSubtitle")}</p>
      ...
      {open && (
        ...
        >
          <div
            ...
            className="relative max-h-[90vh] w-[min(520px,100%)] overflow-y-auto rounded-block bg-white px-5 pt-8 pb-[26px] shadow-[0_40px_80px_-30px_rgba(0,0,0,.5)] sm:px-[38px] sm:pt-10 sm:pb-[34px]"
          >
            <button
              type="button"
              onClick={() => setOpen(false)}
